...
def main():
    ...
    if args.phase == 'train':
        model = vgg16_fcn8s(pretrained=True, **{'num_classes': 7}).cuda()
        logger.write('{}\n'.format(model))
    else:
        model = vgg16_fcn8s(pretrained=False, **{'num_classes': 7}).cuda()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_dir', type=str, default='checkpoint/vgg16_fcns', help='directory to save logfile, checkpoint and output segmetation masks')
